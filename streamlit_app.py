...
if not df.empty:
    ...
    # Gestion des dates : forcer une liste de 2 dates
    ...
    # S'assurer que date_range est toujours une liste de 2 dates
    ...
    with tab1:
        ...
        fig_trend = px.line(
            df_trend, x='date_mutation', y='prix_m2',
        ...
        fig_surf = px.histogram(
            df_filtered, x='surface', nbins=50, range_x=[0, 200],
    ...
    with tab2:
        ...
        with c1:
            ...
            fig_q = px.bar(
                df_q, x='prix_m2', y='quartier', orientation='h',
    ...
    with tab3:
        ...
        fig_tree = px.treemap(
            df_tree, path=['quartier', 'adresse_nom_voie'], values='nb_ventes',
        ...
        with col_v1:
            ...
            fig_avg_addr = px.bar(
                df_avg_addr, x='nb_ventes', y='quartier', orientation='h',
        ...
        with col_v2:
            ...
            fig_top_addr = px.bar(
                df_top_addr, x='nb_ventes', y='adresse_nom_voie', orientation='h',
